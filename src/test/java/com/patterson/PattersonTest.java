...
//Environment variable for user and Sauce_accesskey
    ...
    private static final URL scriptUrl = PattersonTest.class.getResource("/axe.min.js");

    @DataProvider(name = "hardCodedBrowsers", parallel = true)
    public static Object[][] sauceBrowserDataProvider(Method testMethod) {
        return new Object[][]{

                // Ray! Here is where you could load up the VM/Browser combinations //
                // Windows
    ...
    public void PattersonTitle(String type, String browser, String version, String os, String device, Method method) throws Exception {

        WebDriver driver = createDriver(type, browser, version, os, device, method.getName());
        driver.get("https://www.pattersoncompanies.com/home/");
        assertEquals(driver.getTitle(), "Patterson Companies, Inc. - Home");
//        driver.findElement(By.linkText("Who we are")).click();
    }
    @Test(dataProvider = "hardCodedBrowsers")
    public void WhoWeAre(String type, String browser, String version, String os, String device, Method method) throws Exception {

        WebDriver driver = createDriver(type, browser, version, os, device, method.getName());
        driver.get("https://www.pattersoncompanies.com/who-we-are/");
        assertEquals(driver.getTitle(), "Patterson Companies, Inc. - Who we are");
    }
